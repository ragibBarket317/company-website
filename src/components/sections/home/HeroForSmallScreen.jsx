...
const HeroForSmallScreen = () => {
  return (
    <div className="overflow-x-hidden min-h-screen bg-cover bg-center p-6 flex flex-col justify-center">
      {/* MOBILE LOTTIE */}
      ...
      <div className="text-center space-y-5">
        <h1 className="text-3xl text-white font-extrabold leading-snug">
          Powering Organizations Worldwide with Advanced Digital Engineering
        </h1>

        <p className="text-gray-200 font-body text-[18px] leading-relaxed">
          Specialists in mobile, web, AI/ML, and blockchain engineering. Proven
          expertise across app development, AI/ML, and blockchain solutions.
          Skilled teams delivering world-class digital products.
        </p>
