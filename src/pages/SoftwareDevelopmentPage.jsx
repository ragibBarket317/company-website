  ...
  return (
    <div>
      ...
      <div className="bg-white text-gray-700">
        ...
        <section className="container bg-gray-50 py-16 px-6 mx-auto">
          <div className="text-center">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <div
                  key={i}
                  className="bg-white rounded-xl p-8 border border-gray-100 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 text-left"
                >
                  <div className="flex items-center justify-center w-14 h-14 mb-4 rounded-full bg-indigo-50 mx-auto">
                    {item.icon}
                  </div>
                  <h3 className="font-semibold text-indigo-900 text-xl mb-2 text-center">
                    {item.title}
                  </h3>
