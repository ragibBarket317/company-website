    ...
    <div className="font-sans text-gray-800 ">
      ...
      <div className="container py-[80px]">
        <section className="p-10 grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className=" h-[400px] rounded-xl shadow-inner">
      ...
      <div className="container py-[80px]">
        <section className="p-10">
          <h2 className="text-5xl text-white font-bold mb-6 text-center">
            Why Choose Intexa?
          </h2>
      ...
      <div className="container py-[80px]">
        <section className="p-10 grid md:grid-cols-2 gap-10 items-center">
          <div>
            <h2 className="text-4xl text-white font-bold mb-4">Our Mission</h2>
            <p className="text-gray-300">
          ...
          <div className=" h-[300px] flex items-center justify-center rounded-xl shadow-inner">
            <img src={mission} alt="" className="w-96 h-96" />
          </div>
        </section>
      </div>
      ...
      <div className="container py-[80px]">
        <section className="p-10 grid md:grid-cols-2 gap-10 items-center">
          <div className=" h-[300px] flex items-center justify-center rounded-xl shadow-inner">
            <img src={vision} alt="" className="w-96 h-96" />
          </div>
          <div>
