          ...
          <section className="p-10 grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className=" text-[18px] text-gray-400">
                With a team of skilled engineers, designers, and digital
                experts, we ensure every project is handled with innovation,
                speed, and precision.
              </p>
            </div>
          ...
          <section className="p-10 grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p>
                ...
                customer-centric digital solutions. We believe in building
                strong partnerships and delivering value-driven results.
              </p>
            </div>
