...
import WebIndustries from '../components/sections/webDevelopment/WebIndustries'
import WhyPartnerForDevelopment from '../components/sections/webDevelopment/WhyPartnerForDevelopment'
...
export default function WebDevelopmentPage() {
  ...
  useGSAP(
    () => {
      devStepsRef.current.forEach((card) => {
        gsap.fromTo(
          card,
          {
            opacity: 0,
            ...
            <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-6 text-left">
              {[
                ...
                <div
                  ...
                  className="backdrop-blur-xl opacity-0 bg-white/10 border border-white/20 p-6 hover:bg-white/20 rounded-lg shadow-sm hover:shadow-md"
                  // style={{ opacity: 0 }}
                >
